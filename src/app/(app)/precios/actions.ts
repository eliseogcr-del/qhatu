...
// producto o el almacén de una línea, para mostrar el precio calculado
// sin que el usuario pueda escribirlo a mano. La autoridad real sigue
// siendo el servidor al guardar (acá solo se usa para pintar el precio en
// pantalla mientras se arma el formulario).
